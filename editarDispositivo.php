              ...
              <form class="needs-validation" novalidate>
                ...
                <input type="hidden" class="form-control" name="idDispositivo" placeholder="" value="<?php echo $idDispositivo; ?>" required>
                  <div class="col-md-4 mb-3" id="imeiMensaje">
                    ...
                    <input type="text" class="form-control" name="imei" placeholder="" value="<?php echo $imei; ?>"  id="imei"  required>
                  ...
                  <div class="col-md-4 mb-3" id="modeloMensaje">
                    ...
                    <input type="text" class="form-control" name="modelo" placeholder="" value="<?php echo $modelo; ?>" id="modelo" required>
                    <div class="valid-tooltip">
                      Looks good!
                    </div>
                  </div>
                  <div class="col-md-4 mb-3"  id="precioMensaje">
                    ...
                    <input type="number" step="0.01" min="0" max="999" class="form-control" name="precio" placeholder="" value="<?php echo $precio; ?>"  id="precio" required>
                    <div class="valid-tooltip">
                      Looks good!
                    </div>
                  </div>
