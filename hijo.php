      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <table class="table">
          ...
          while ($mostrar = mysqli_fetch_array($result)) {
            ...
            from seguimiento
            where fechaFin is null and idHijo='$idHijo'";
          ...
          ?>
            <tbody id="myTable">
              <tr>
                <td><?php echo $cont ?></td>
                <td>
                  <button id="activarDesactivarButton" type="button" class="btn btn-primary" data-toggle="modal" data-target=".exampleModal" onclick="onclickSeleccionarHijo(<?php echo $mostrar['idHijo'] ?>, <?php echo $estaActivado ? '1' : '0'?>)">
                    <i class="fa fa-home"></i>
                  <?php echo $estaActivado ? "Desactivar" : "Activar"?>
                  </button>
                </td>
                <td><?php echo $mostrar['nombreHijo'] ?></td>
                <td><?php echo $estaActivado ? "Encendido" : "Apagado"?></td>
...
<div class="modal fade exampleModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Configurar dispositivo</h5>
        ...
        <form action="seguimientos.php" method="POST">
          <input type="hidden" id='idHijoSeleccionado' name="idHijoSeleccionado">
  ...
  <script>
    ...
    function onclickSeleccionarHijo(idHijoSeleccionado, estado) {
      var accion = estado == "1" ? "desactivar": "  activar";
      $('#idHijoSeleccionado').val(idHijoSeleccionado);
      $('#mensajeModal').empty();
      $('#mensajeModal').append("Está seguro de " + accion + " el monitoreo?");
    }
  </script>
